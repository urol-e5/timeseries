...
```{r}
pH1 <- read.csv("data/3_environmental/3_20200920_SN20697595_Site1_pH.csv", header=T, sep=",", na.strings="NA",skip=1) #load  data
...
# pH3 <- read.csv("data/3_environmental/", header=T, sep=",", na.strings="NA", skip=2) #load  data
# pH3 <- pH3[,1:4]

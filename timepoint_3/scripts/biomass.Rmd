...
Data <- read.csv("data/3_biomass/3_biomass_data.csv")
Data <- na.omit(Data)
...
homog_vol <- read.csv("data/3_homogenate_vols/3_homogenate_vols.csv", header=TRUE)
...
output<-left_join(afdw,dw)%>%
  write_csv(path = "output/3_biomass.csv")
```

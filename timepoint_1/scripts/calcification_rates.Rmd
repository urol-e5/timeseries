...
calc.data <- read.csv("data/1_calcification/1_TA_data.csv")
...
```{r}
sample.data <- read.csv("../timepoint_1/output/1_surface_area.csv") #bring in SA and volume data sheet
...
resp.data <- read.csv("data/1_calcification/1_DeltaTA_metadata.csv")
...
write.csv(full.calc.data, 'output/1_calcification_rates.csv') 

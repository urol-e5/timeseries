...
png(filename="Figures/Environmental_Radar_Temperature.png", width=2280, heigh=1880, units="px", res=300)
...
png(filename="Figures/Environmental_Radar_pH_light.png", width=2280, heigh=1880, units="px", res=300)
ggRadar(radar, aes(colour=site), scales="fixed")+
  ggplot2::theme_minimal()+
  ggplot2::theme(text=element_text(color="black", size=11))+
  ggplot2::theme(legend.position="top")+
...
ggsave(file="Figures/Environmental_Temperature_summary.png", temp_summary_plot, width = 7, height = 4, units = c("in"))
```

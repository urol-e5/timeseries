...
IDEA: Host phenotype = calcification (host fitness); could also do symbiont fitness (perhaps max photosynthesis AM)? 

Next script: Models of 1) best predictors of host fitness (calcification); 2) best predictors of symbiont fitness (Am first, then could look into Ik or E) or holobiont fitness (P:R ratios); 3) Lag times between symbiont and host responses

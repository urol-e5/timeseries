...
```{r}
pcaHaplotype_afdw<-ggplot2::autoplot(scaled_data_species, data=pca_data_species, frame.colour="haplotype", loadings=FALSE,  colour="haplotype", shape="haplotype", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=TRUE, loadings.label.size=5, loadings.label.vjust=-1, size=5, frame.type = 'norm', alpha=0.5) + 
  scale_colour_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) +
  scale_fill_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) + 
  scale_shape_manual(values=c(16, 16, 15, 16, 17))+
  theme_classic()+
  #geom_text(x=0, y=0.28, label=paste("PERMANOVA p =", z_species$`Pr(>F)`[1]), size=6, color=ifelse(z_species$`Pr(>F)`[1] < 0.05, "black", "darkgray")) + 
...
ggsave(filename="Figures/NormalizerPCA/Species_Host_PCA.pdf", plot=pcaSpecies_afdw_host, dpi=300, width=5, height=5, units="in")
```
...
ggsave(filename="Figures/NormalizerPCA/Species_Host_BiPlot.pdf", plot=pcaSpecies_afdw_host_biplot, dpi=300, width=5, height=5, units="in")
```
...
# PerMANOVA - partitioning the euclidean distance matrix by species
permanova<-adonis2(vegan ~ species/haplotype, data = pca_data_haplotype_host, method='eu')
z_haplotype<-permanova
z_haplotype
...
Groupings by haplotype:  
```{r}
pcaHaplotype_afdw_host<-ggplot2::autoplot(scaled_data_haplotype_host, data=pca_data_haplotype_host, frame.colour="haplotype", loadings=FALSE,  shape="haplotype", colour="haplotype", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=TRUE, loadings.label.size=5, loadings.label.vjust=-1, size=5, frame.type = 'norm', alpha=0.5) + 
  scale_colour_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) +
  scale_fill_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) + 
  scale_shape_manual(values=c(16, 16, 15, 16, 17))+
  theme_classic()+
  #geom_text(x=0.05, y=0.26, label="PERMDISP posthoc POR p=0.16, POC p=0.99", size=4, color="darkgray") +
  #geom_text(x=0.05, y=0.22, label="PERMANOVA posthoc POR p=0.64, POC p=0.54", size=4, color="darkgray") +
  #xlim(-0.3,0.5)+
  #ylim(-0.3, 0.5)+
  xlab("PC1")+
  ylab("PC2")+
...
ggsave(filename="Figures/NormalizerPCA/Haplotype_Host_PCA.pdf", plot=pcaHaplotype_afdw_host, dpi=300, width=5, height=5, units="in")
```

Generate a biplot for this PCA. 
```{r}
pcaHaplotype_afdw_host_biplot<-ggplot2::autoplot(scaled_data_haplotype_host, data=pca_data_haplotype_host, frame.colour="haplotype", shape="haplotype", loadings=TRUE,  colour="haplotype", loadings.label.colour="black", loadings.colour="black", loadings.label=TRUE, frame=FALSE, loadings.label.size=5, loadings.label.vjust=-1, size=5, frame.type = 'norm', alpha=0.0) + 
  scale_colour_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) +
  scale_fill_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) + 
  scale_shape_manual(values=c(16, 16, 15, 16, 17))+
  theme_classic()+
...
ggsave(filename="Figures/NormalizerPCA/Haplotype_Host_BiPlot.pdf", plot=pcaHaplotype_afdw_host_biplot, dpi=300, width=5, height=5, units="in")
```
...
ggsave(filename="Figures/NormalizerPCA/Species_Symbiont_PCA.pdf", plot=pcaSpecies_afdw_sym, dpi=300, width=7, height=5, units="in")
```
...
ggsave(filename="Figures/NormalizerPCA/Species_Sym_BiPlot.pdf", plot=pcaSpecies_afdw_sym_biplot, dpi=300, width=5, height=5, units="in")
```
...
permanova<-adonis2(vegan ~ species/haplotype, data = pca_data_haplotype_sym, method='eu')
z_haplotype<-permanova
z_haplotype

# adonis2(formula = vegan ~ haplotype, data = pca_data_haplotype_sym, method = "eu")
#                    Df SumOfSqs      R2      F Pr(>F)    
# species             2   1174.5 0.31829 99.885  0.001 ***
# species:haplotype   2    128.5 0.03483 10.932  0.001 ***
# Residual          406   2387.0 0.64687                  
# Total             410   3690.0 1.00000        
...
Groupings by haplotype:  
```{r}
pcaHaplotype_afdw_sym<-ggplot2::autoplot(scaled_data_haplotype_sym, data=pca_data_haplotype_sym, frame.colour="haplotype", loadings=FALSE,  colour="haplotype", shape="haplotype", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=TRUE, loadings.label.size=5, loadings.label.vjust=-1, size=5, frame.type = 'norm', alpha=0.5) + 
  scale_colour_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) +
  scale_fill_manual(values=c("darkgray", "orange", "orange", "purple2", "purple2")) + 
  scale_shape_manual(values=c(16, 16, 15, 16, 17))+ 
  theme_classic()+
  #geom_text(x=0, y=0.18, label="PERMANOVA posthoc POC p=1.00, POR p=0.01", size=4, color="black") +
    #geom_text(x=0, y=0.14, label="PERMDISP posthoc POC p=0.99, POR p=0.15", size=4, color="darkgray") +
  xlim(-0.2,0.2)+
  ylim(-0.22, 0.18)+
  xlab("PC1")+
  ylab("PC2")+
...
ggsave(filename="Figures/NormalizerPCA/Haplotype_Symbiont_PCA.pdf", plot=pcaHaplotype_afdw_sym, dpi=300, width=8, height=5, units="in")
```
...
ggsave(filename="Figures/NormalizerPCA/Haplotype_Sym_BiPlot.pdf", plot=pcaHaplotype_afdw_sym_biplot, dpi=300, width=5, height=5, units="in")
```

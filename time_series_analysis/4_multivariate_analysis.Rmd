...
acr_data_afdw<-master%>%
  select(colony_id_corr, timepoint, species, site, Host_AFDW.mg.cm2, Sym_AFDW.mg.cm2, Ratio_AFDW.mg.cm2, Total_Chl, Total_Chl_cell, prot_mg.mgafdw, cells.mgAFDW, cre.umol.mgafdw, Am, AQY, Rd, calc.umol.cm2.hr)%>%
...
timepoint             3   383.40 0.31324 17.1488  0.001 ***
site             2    86.45 0.07063  5.8002  0.001 ***
timepoint:site   6    75.96 0.06206  1.6989  0.010 ** 
Residual             91   678.18 0.55407                   
...
adonis2(formula = vegan ~ timepoint * site, data = por_data_afdw, method = "eu")
                     Df SumOfSqs      R2       F Pr(>F)    
timepoint             3   288.68 0.17559 11.3444  0.001 ***
site             2   200.11 0.12172 11.7956  0.001 ***
timepoint:site   6    86.45 0.05259  1.6987  0.006 ** 
Residual            126  1068.76 0.65010                   
...
adonis2(formula = vegan ~ timepoint * site, data = poc_data_afdw, method = "eu")
                     Df SumOfSqs      R2       F Pr(>F)    
timepoint             3   403.37 0.24899 16.1312  0.001 ***
site             2    62.64 0.03867  3.7575  0.001 ***
timepoint:site   6   120.43 0.07434  2.4081  0.001 ***
Residual            124  1033.56 0.63800                   

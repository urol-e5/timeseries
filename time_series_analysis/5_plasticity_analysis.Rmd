...
dist_all_dotplot<-dist_all_calc%>%
    ...
    #add stats
    geom_text(x=2, y=20, size=4, label="p(Site)=0.061", color="darkgray")+
    geom_text(x=2, y=19, size=4, label="p(Species)<0.001", color="black")+
    geom_text(x=2, y=18, size=4, label="p(Site x Species)=0.185", color="darkgray")+
...
site_code          2   42.7   21.34   2.896 0.061627 .  
species            2  126.9   63.45   8.611 0.000439 ***
site_code:species  4   47.0   11.75   1.595 0.184857    
Residuals         73  537.9    7.37    
...
dist_host_dotplot<-dist_host_calc%>%
    ...
    #add stats
    geom_text(x=2, y=20, size=4, label="p(Site)=0.058", color="darkgray")+
    geom_text(x=2, y=19, size=4, label="p(Species)<0.001", color="black")+
    geom_text(x=2, y=18, size=4, label="p(Site x Species)=0.003", color="black")+
...
```
                  ...
                  Df Sum Sq Mean Sq F value   Pr(>F)    
site_code          2   26.1   13.05   2.939  0.05851 .  
species            2  190.5   95.23  21.440 3.24e-08 ***
site_code:species  4   78.3   19.58   4.407  0.00281 ** 
Residuals         82  364.2    4.44    
...
dist_sym_dotplot<-dist_sym_calc%>%
    ...
    #add stats
    geom_text(x=2, y=20, size=4, label="p(Site)=0.253", color="darkgray")+
    geom_text(x=2, y=19, size=4, label="p(Species)=0.201", color="darkgray")+
    geom_text(x=2, y=18, size=4, label="p(Site x Species)=0.207", color="darkgray")+
...
```
                  ...
                  Df Sum Sq Mean Sq F value Pr(>F)
site_code          2   19.1   9.529   1.397  0.253
species            2   22.3  11.140   1.633  0.201
site_code:species  4   41.1  10.279   1.507  0.207
Residuals         85  579.8   6.821 

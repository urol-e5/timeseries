...
dist_all_dotplot<-dist_all_calc%>%
    ...
    #add stats
    geom_text(x=2, y=20, size=4, label="p(Site)=0.074", color="darkgray")+
    geom_text(x=2, y=19, size=4, label="p(Species)<0.001", color="black")+
    geom_text(x=2, y=18, size=4, label="p(Site x Species)=0.895", color="darkgray")+
...
site_code          2   39.9   19.97   2.699    0.074 .  
species            2  264.7  132.35  17.884 4.78e-07 ***
site_code:species  4    8.1    2.02   0.272    0.895    
Residuals         73  540.3    7.40        
...
dist_host_dotplot<-dist_host_calc%>%
    ...
    #add stats
    geom_text(x=2, y=20, size=4, label="p(Site)=0.010", color="black")+
    geom_text(x=2, y=19, size=4, label="p(Species)<0.001", color="black")+
    geom_text(x=2, y=18, size=4, label="p(Site x Species)=0.425", color="darkgray")+
...
```
                  ...
                  Df Sum Sq Mean Sq F value   Pr(>F)    
site_code          2   41.0   20.48   4.863   0.0101 *  
species            2  423.5  211.77  50.300 5.56e-15 ***
site_code:species  4   16.4    4.11   0.976   0.4251    
Residuals         82  345.2    4.21     

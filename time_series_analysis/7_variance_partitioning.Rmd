...
ggsave(varpartBarplot_Species, file="Figures/Multivariate/VarPart_Species.png", width=18, height=8)
...
ggsave(varpartBarplot_Fraction, file="Figures/Multivariate/VarPart_Fraction.png", width=18, height=8)

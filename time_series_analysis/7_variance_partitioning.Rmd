...
#The effect of site with overlap with timepoint is not significant p=0.056
...
varpart_acr_afdw_parts$PercVar[which(varpart_acr_afdw_parts$Variance<0.01)]<-NA
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_por_afdw<-varpart(por_data_afdw_log[,6:19], por_data_afdw_log$haplotype, por_data_afdw_log$timepoint, por_data_afdw_log$site) 

##Check variance explained by individual fractions
varpart_por_afdw$part
# Individual fractions                                   
# [a] = X1 | X2+X3       1               0.05546     TRUE
# [b] = X2 | X1+X3       3               0.19331     TRUE
# [c] = X3 | X1+X2       2               0.03860     TRUE
# [d]                    0               0.00066    FALSE
# [e]                    0               0.00563    FALSE
# [f]                    0               0.06956    FALSE
# [g]                    0              -0.00129    FALSE
# [h] = Residuals                        0.63807    FALSE

# is variance explained by both site and haplotype, since we have nested haplotypes 

##Check model significance
anova(rda(por_data_afdw_log[,6:19]~ por_data_afdw_log$haplotype + por_data_afdw_log$timepoint + por_data_afdw_log$site))
#The model is significant p=0.001

##Check variance explained by model
RsquareAdj(rda(por_data_afdw_log[,6:19]~ por_data_afdw_log$haplotype + por_data_afdw_log$timepoint + por_data_afdw_log$site))$adj.r.squared*100
#The model explains 36.19% of the variation in coral physiology in Porites

##Check effect of timepoint 
anova(rda(por_data_afdw_log[,6:19], por_data_afdw_log$timepoint))
#The effect of timepoint with overlap with site and haplotype is significant p=0.001 
anova(rda(por_data_afdw_log[,6:19], por_data_afdw_log$timepoint,  por_data_afdw_log$site))
#The effect of timepoint alone controlling for siet is significant p=0.001 
...
#Effect of haplotype with time and site overlap is significant 
anova(rda(por_data_afdw_log[,6:19], por_data_afdw_log$haplotype,  por_data_afdw_log$site))
#Effect of haplotype controlling for site is signifncant 
anova(rda(por_data_afdw_log[,6:19], por_data_afdw_log$haplotype,  por_data_afdw_log$timepoint))
#haplotype is significant controlling for time 

##Check effect of site 
anova(rda(por_data_afdw_log[,6:19], por_data_afdw_log$site))
#The effect of site with overlap with timepoint and haplotype is significant p=0.001
...
varpart_por_afdw_parts<-data.frame(Parts=c("Haplotype", "Season", "Site", "NA", "NA", "Site&Haplotype", "NA", "Residuals"), 
...
varpart_por_afdw_parts$PercVar[which(varpart_por_afdw_parts$Variance<0.01)]<-NA
varpart_por_afdw_parts$Species<-rep("Porites", nrow(varpart_por_afdw_parts))

rows_to_keep <- c(1, 2, 3, 6, 8)
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_poc_afdw<-varpart(poc_data_afdw_log[,6:19], poc_data_afdw_log$haplotype, poc_data_afdw_log$timepoint, poc_data_afdw_log$site)

##Check variance explained by individual fractions
varpart_poc_afdw$part
#Individual fractions                                   
# [a] = X1 | X2+X3       1               0.00394     TRUE
# [b] = X2 | X1+X3       3               0.28398     TRUE
# [c] = X3 | X1+X2       2               0.01327     TRUE
# [d]                    0               0.00010    FALSE
# [e]                    0              -0.00283    FALSE
# [f]                    0              -0.00179    FALSE
# [g]                    0              -0.00068    FALSE
# [h] = Residuals                        0.70401    FALS

##Check model significance
anova(rda(poc_data_afdw_log[,6:19]~ poc_data_afdw_log$haplotype+ poc_data_afdw_log$timepoint + poc_data_afdw_log$site))
#The model is significant p=0.001

##Check variance explained by model
RsquareAdj(rda(poc_data_afdw_log[,6:19]~ poc_data_afdw_log$haplotype + poc_data_afdw_log$timepoint + poc_data_afdw_log$site))$adj.r.squared*100
...
anova(rda(poc_data_afdw_log[,6:19], poc_data_afdw_log$haplotype))
#effect of haplotype is not significant 
...
#The effect of site with overlap with timepoint is not significant 
anova(rda(poc_data_afdw_log[,6:19], poc_data_afdw_log$site,  poc_data_afdw_log$timepoint))
#The effect of site alone (controlling for timepoint) is significant  
anova(rda(poc_data_afdw_log[,6:19], poc_data_afdw_log$site,  poc_data_afdw_log$haplotype))
#The effect of site alone (controlling for haplotype) is not significant 
```
...
varpart_poc_afdw_parts<-data.frame(Parts=c("Haplotype","Season", "Site", "NA", "NA", "NA", "NA", "Residuals"), 
...
varpart_poc_afdw_parts$PercVar[which(varpart_poc_afdw_parts$Variance<0.01)]<-NA
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_por_afdw_host<-varpart(por_data_afdw_log_host[,6:10], por_data_afdw_log_host$haplotype, por_data_afdw_log_host$timepoint, por_data_afdw_log_host$site)

##Check variance explained by individual fractions
varpart_por_afdw_host$part
#Individual fractions                                   
# [a] = X1 | X2+X3       1               0.00662     TRUE
# [b] = X2 | X1+X3       3               0.27978     TRUE
# [c] = X3 | X1+X2       2               0.01686     TRUE
# [d]                    0              -0.00239    FALSE
# [e]                    0              -0.00711    FALSE
# [f]                    0               0.03095    FALSE
# [g]                    0              -0.00210    FALSE
# [h] = Residuals                        0.67740    FALSE

##Check model significance
anova(rda(por_data_afdw_log_host[,6:10]~ por_data_afdw_log_host$haplotype + por_data_afdw_log_host$timepoint + por_data_afdw_log_host$site))
#The model is significant p=0.001

##Check variance explained by model
RsquareAdj(rda(por_data_afdw_log_host[,6:10]~ por_data_afdw_log_host$haplotype + por_data_afdw_log_host$timepoint + por_data_afdw_log_host$site))$adj.r.squared*100
#The model explains 32.26% of the variation in coral physiology in Porites Host
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_poc_afdw_host<-varpart(poc_data_afdw_log_host[,6:10], poc_data_afdw_log_host$haplotype, poc_data_afdw_log_host$timepoint, poc_data_afdw_log_host$site)

##Check variance explained by individual fractions
varpart_poc_afdw_host$part
#Individual fractions                                   
# [a] = X1 | X2+X3       1              -0.00354     TRUE
# [b] = X2 | X1+X3       3               0.18283     TRUE
# [c] = X3 | X1+X2       2               0.03051     TRUE
# [d]                    0              -0.00041    FALSE
# [e]                    0               0.00037    FALSE
# [f]                    0               0.01263    FALSE
# [g]                    0               0.00286    FALSE
# [h] = Residuals                        0.77475    FALSE

##Check model significance
anova(rda(poc_data_afdw_log_host[,6:10]~ poc_data_afdw_log_host$haplotype + poc_data_afdw_log_host$timepoint + poc_data_afdw_log_host$site))
#The model is significant p=0.001
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_por_afdw_sym<-varpart(por_data_afdw_log_sym[,6:14], por_data_afdw_log_sym$haplotype, por_data_afdw_log_sym$timepoint, por_data_afdw_log_sym$site)

##Check variance explained by individual fractions
varpart_por_afdw_sym$part
#Individual fractions                                   
# [a] = X1 | X2+X3       1               0.06019     TRUE
# [b] = X2 | X1+X3       3               0.18120     TRUE
# [c] = X3 | X1+X2       2               0.04634     TRUE
# [d]                    0               0.00522    FALSE
# [e]                    0               0.00521    FALSE
# [f]                    0               0.08024    FALSE
# [g]                    0               0.00122    FALSE
# [h] = Residuals                        0.62037    FALSE

##Check model significance
anova(rda(por_data_afdw_log_sym[,6:14]~ por_data_afdw_log_sym$haplotype + por_data_afdw_log_sym$timepoint + por_data_afdw_log_sym$site))
#The model is significant p=0.001
...
#The model explains 37.96% of the variation in coral physiology in Porites Symbiont
...
```{r}
##Run varpart function with responses and explanatory variables of interest
varpart_poc_afdw_sym<-varpart(poc_data_afdw_log_sym[,6:14],poc_data_afdw_log_sym$haplotype, poc_data_afdw_log_sym$timepoint, poc_data_afdw_log_sym$site)

##Check variance explained by individual fractions
varpart_poc_afdw_sym$part
#Individual fractions                                   
# [a] = X1 | X2+X3       1               0.00443     TRUE
# [b] = X2 | X1+X3       3               0.28012     TRUE
# [c] = X3 | X1+X2       2               0.00647     TRUE
# [d]                    0              -0.00263    FALSE
# [e]                    0              -0.00299    FALSE
# [f]                    0              -0.00097    FALSE
# [g]                    0              -0.00086    FALSE
...
##Check model significance
anova(rda(poc_data_afdw_log_sym[,6:14]~ poc_data_afdw_log_sym$haplotype + poc_data_afdw_log_sym$timepoint + poc_data_afdw_log_sym$site))
#The model is significant p=0.001
...
varpart_por_afdw_host_plot<-data.frame(Parts=c("Haplotype", "Season", "Site", "NA", "NA", "Site&Haplotype", "NA", "Residuals"), 
...
rows_to_keep <- c(2, 3, 6, 8)
varpart_por_afdw_host_plot <- varpart_por_afdw_host_plot[rows_to_keep, ]

#varpart_poc_afdw_host
varpart_poc_afdw_host_plot<-data.frame(Parts=c("NA", "Season", "Site", "NA", "NA", "Site&Haplotype", "NA", "Residuals"), 
...
varpartBarplot_all.host<-ggplot(varpart_afdw_host_all, aes(x=Species, y=Percent, fill=Parts)) + 
  geom_bar(position="stack", stat="identity", colour="black")+
  scale_fill_manual(name="Predictors", values = c("lightblue2", "cyan2", "purple2", "gray"),)+
  theme_classic()+
  theme(axis.title.x = element_text(size = 18), axis.title.y = element_text(size = 18), 
        axis.text.x=element_text(size=14, colour="black"), axis.text.y=element_text(size=14, colour="black"), 
        legend.text=element_text(size=12), legend.title=element_text(size=15))+
...
varpart_por_afdw_sym_plot<-data.frame(Parts=c("Haplotype", "Season", "Site", "NA", "NA", "Site&Haplotype", "NA", "Residuals"), 
...
varpart_poc_afdw_sym_plot<-data.frame(Parts=c("Haplotype", "Season", "Site",  "NA", "NA", "NA", "NA", "Residuals"), 
...
varpart_poc_afdw_sym_plot$PercVar[which(varpart_poc_afdw_sym_plot$Variance<.01)]<-NA
...
ggsave(all.plots, file="Figures/Multivariate/VarPart_Panel.pdf", width=15, height=6.5)

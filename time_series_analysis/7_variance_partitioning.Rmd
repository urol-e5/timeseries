...
varpart_afdw_parts_all$Parts<-factor(varpart_afdw_parts_all$Parts, levels=c("Site", "Season", "Residuals"), ordered=TRUE)
...
varpartBarplot_all.holo<-ggplot(varpart_afdw_parts_all, aes(x=Species, y=Percent, fill=Parts)) + 
  ...
  scale_fill_manual(name="Predictors", values = c("#18DEC1FF", "#4681F7FF", "darkgray"))+
  theme_classic()+
...
ggsave(varpartBarplot_all.holo, file="Figures/Multivariate/VarPart_All_Holobiont.png", width=13, height=5)

...
varpartBarplot_all.holo<-ggplot(varpart_afdw_parts_all, aes(x=Species, y=Percent, fill=Parts)) + 
  ...
  scale_fill_manual(name="Predictors", values = c("#18DEC1FF", "#4681F7FF", "darkgray"), labels = c("Site", "Season", "Residuals"))+
  theme_classic()+
  ...
  theme(plot.title=element_text(hjust=0.5));varpartBarplot_all.holo

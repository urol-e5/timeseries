...
acrPCA<-ggplot(acr_data, aes(.fittedPC1, .fittedPC2, color=site_code)) + 
  ...
  geom_text(x=6, y=-1.85, label=paste("p(Timepoint)=", z_acr$`Pr(>F)`[1]), size=4, color="black") + 
  geom_text(x=6, y=-2.25, label=paste("p(Site)=", z_acr$`Pr(>F)`[2]), size=4, color="black") + 
  geom_text(x=6, y=-2.65, label=paste("p(Timepoint x Site)=", z_acr$`Pr(>F)`[3]), size=4, color="black") + 
  theme(legend.text = element_text(size=18), 
         legend.position="none",
         plot.background = element_blank(),
         legend.title = element_blank(), 
...
acrFullPCA<-ggdraw(acrPCAfull + theme_half_open(12)) +
  draw_plot(acrArrows, .45, .5, .55, .5); acrFullPCA #x, y, w, h
...
porPCA<-ggplot(por_data, aes(.fittedPC1, .fittedPC2, color=site_code)) + 
  ...
  geom_text(x=6, y=-3.4, label=paste("p(Timepoint)=", z_por$`Pr(>F)`[1]), size=4, color="black") + 
  geom_text(x=6, y=-3.9, label=paste("p(Site)=", z_por$`Pr(>F)`[2]), size=4, color="black") + 
  geom_text(x=6, y=-4.4, label=paste("p(Timepoint x Site)=", z_por$`Pr(>F)`[3]), size=4, color="darkgray") + 
  theme(legend.text = element_text(size=18), 
         legend.position="none",
         plot.background = element_blank(),
         legend.title = element_blank(), 
...
porFullPCA<-ggdraw(porPCAfull + theme_half_open(12)) +
  draw_plot(porArrows, .45, .5, .55, .5); porFullPCA #x, y, w, h
...
pocPCA<-ggplot(poc_data, aes(.fittedPC1, .fittedPC2, color=site_code)) + 
  ...
  geom_text(x=7, y=-2.5, label=paste("p(Timepoint)=", z_poc$`Pr(>F)`[1]), size=4, color="black") + 
  geom_text(x=7, y=-3.25, label=paste("p(Site)=", z_poc$`Pr(>F)`[2]), size=4, color="black") + 
  geom_text(x=7, y=-4, label=paste("p(Timepoint x Site)=", z_poc$`Pr(>F)`[3]), size=4, color="black") + 
  theme(legend.text = element_text(size=18), 
         legend.position="none",
         plot.background = element_blank(),
         plot.margin = margin(1, 1, 1, 1, "cm"),
...
pocFullPCA<-ggdraw(pocPCAfull + theme_half_open(12)) +
  draw_plot(pocArrows, .45, .5, .55, .5); pocFullPCA #x, y, w, h

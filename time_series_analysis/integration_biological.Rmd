...
```{r}
symbiont_responses<-c("cells.mgAFDW", "Sym_AFDW.mg.cm2", "chla.ug.mgAFDW", "chlc2.ug.mgAFDW", "chla.ug.cell", "chlc2.ug.cell", "Am", "AQY") 
...
```{r}
chlc2plot_cell<-chlc2plot_cell+theme(legend.position="right")

symbiont_univ1<-plot_grid(symbplot_afdw, sAFDWplot, am_plot, aqy_plot, NULL, ncol=5, nrow=1, rel_widths = c(1,1,1,1,0.5))
symbiont_univ2<-plot_grid(chlaplot_afdw, chlaplot_cell, chlc2plot_afdw, chlc2plot_cell, NULL, ncol=5, nrow=1, rel_widths = c(1,1,1,1.5,0.1))
symbiont_univ<-plot_grid(symbiont_univ1, symbiont_univ2, ncol=1, nrow=2, rel_widths = c(1,1))

ggsave(filename="Figures/Symbiont_Univariate_Panel.pdf", plot=symbiont_univ, dpi=150, width=22, height=8, units="in")
```

Generate a panel of responses for host/holobiont metrics.  

```{r}
ratioAFDWplot<-ratioAFDWplot+theme(legend.position="none")
...
holobiont_univ<-plot_grid(holobiont_univ1, holobiont_univ2, ncol=1, nrow=2, rel_widths = c(1, 1))

ggsave(filename="Figures/Holobiont_Univariate_Panel.pdf", plot=holobiont_univ, dpi=150, width=22, height=8, units="in")
```
...
acr_tp4_scaled<-prcomp(acr_tp4_data[c(5:19)], scale=TRUE, center=TRUE) 
...
acr_data_afdw<-master%>%
  ...
  filter(Sym_AFDW.mg.cm2>0)%>%
  #filter(Ratio_AFDW.mg.cm2>0)%>%
  filter(chla.ug.mgAFDW<2)%>%
  filter(species=="Acropora")%>%
  #filter(prot_mg.mgafdw<1.5)%>% #remove outliers
  rename(Symbiont_Biomass=Sym_AFDW.mg.cm2, Chl_a=chla.ug.mgAFDW, Chl_c2=chlc2.ug.mgAFDW, Symbiont_Density=cells.mgAFDW, Chl_a_cell=chla.ug.cell, Chl_c2_cell=chlc2.ug.cell)
...
poc_tp1_scaled<-prcomp(poc_tp1_data[c(5:12)], scale=TRUE, center=TRUE) 
...
poc_tp2_scaled<-prcomp(poc_tp2_data[c(5:12)], scale=TRUE, center=TRUE) 
...
poc_tp3_scaled<-prcomp(poc_tp3_data[c(5:12)], scale=TRUE, center=TRUE) 
...
poc_tp4_scaled<-prcomp(poc_tp4_data[c(5:12)], scale=TRUE, center=TRUE) 
...
acr_tp1_scaled<-prcomp(acr_tp1_data[c(5:12)], scale=TRUE, center=TRUE) 
...
acr_tp2_scaled<-prcomp(acr_tp2_data[c(5:12)], scale=TRUE, center=TRUE) 
...
acr_tp3_scaled<-prcomp(acr_tp3_data[c(5:12)], scale=TRUE, center=TRUE) 
...
acr_tp4_scaled<-prcomp(acr_tp4_data[c(5:12)], scale=TRUE, center=TRUE) 
...
por_tp1_scaled<-prcomp(por_tp1_data[c(5:12)], scale=TRUE, center=TRUE) 
...
por_tp2_scaled<-prcomp(por_tp2_data[c(5:12)], scale=TRUE, center=TRUE) 
...
por_tp3_scaled<-prcomp(por_tp3_data[c(5:12)], scale=TRUE, center=TRUE) 
...
por_tp4_scaled<-prcomp(por_tp4_data[c(5:12)], scale=TRUE, center=TRUE) 

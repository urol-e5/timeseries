...
```{r}
density_model_poc<-lmer(log(cells.mgAFDW+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(cells.mgAFDW>0 & species=="Pocillopora"))
...
```{r}
density_model_por<-lmer(log(cells.mgAFDW+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(cells.mgAFDW>0 & species=="Porites"))
...
```{r}
am_model<-lmer(log(Am+1)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)
qqPlot(residuals(am_model))
```
...
```{r}
am_model_poc<-lmer(log(Am+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Pocillopora"))
...
```{r}
am_model_por<-lmer(log(Am+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Porites"))
...
```{r}
aqy_model<-lmer(log(AQY+1)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)
qqPlot(residuals(aqy_model))
```
...
```{r}
aqy_model_poc<-lmer(log(AQY+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Pocillopora"))
...
```{r}
aqy_model_por<-lmer(log(AQY+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Porites"))
...
```{r}
rd_model<-lmer(log(Rd+1)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)
qqPlot(residuals(rd_model))
```
...
```{r}
rd_model_poc<-lmer(log(Rd+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Pocillopora"))
...
```{r}
rd_model_por<-lmer(log(Rd+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Porites"))
...
```{r}
Ik_model<-lmer(log(Ik+1)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)
qqPlot(residuals(Ik_model))
```
...
```{r}
Ik_model_poc<-lmer(log(Ik+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Pocillopora"))
...
```{r}
Ik_model_por<-lmer(log(Ik+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Porites"))
...
`Ik_model<-lmer(log(Ik)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)` 
```{r}
Ic_model<-lmer(log(Ic+1)~timepoint*species*site+(1|colony_id_corr), na.action=na.omit, data=master)
qqPlot(residuals(Ic_model))
```
...
```{r}
Ic_model_poc<-lmer(log(Ic+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Pocillopora"))
...
```{r}
Ic_model_por<-lmer(log(Ic+1)~timepoint*site+(1|colony_id_corr), na.action=na.omit, data=master, subset=c(species=="Porites"))

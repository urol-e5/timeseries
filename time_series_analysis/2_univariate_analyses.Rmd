...
```{r}
pi_figure<-plot_grid(am_plot, aqy_plot, rd_plot, Ik_plot, Ic_plot, labels = c("", "", "", "", ""), ncol=5, nrow=1, rel_widths = c(.8, .8, .8, .8, 1), label_size = 20, label_x = 0.1)
...
symbiont_univ<-plot_grid(symbplot_afdw, sAFDWplot, am_plot, aqy_plot, Ik_plot, Ic_plot, chlplot_total, chlplot_total_cell, ratioAFDWplot, ncol=3, nrow=3, rel_widths = c(1,1), align="h", label_y=1, labels=c("A", "B", "C", "D", "E", "F", "G", "H", "I"), label_size=20)
...
ggsave(filename="Figures/Univariate/Host_Univariate_Panel.png", plot=host_univ2, dpi=150, width=20, height=11, units="in")
```

...
rd_plot_haplotype<-rd_plot_haplotype+theme(axis.text.x=element_blank()) + theme(axis.title.x=element_blank())+ theme(axis.title.y=element_text(size=12))
calcplot_cm2_haplotype<-calcplot_cm2_haplotype+ theme(axis.title.y=element_text(size=12))
 
host_univ_haplotype<-plot_grid(tacplot_afdw_haplotype, hAFDWplot_haplotype, protplot_afdw_haplotype, rd_plot_haplotype, calcplot_cm2_haplotype, ncol=1, nrow=5, rel_heights = c(0.8, 0.8, 0.8, 0.8, 1), align="v", label_y=1, labels=c("A", "B", "C", "D", "E"), label_size=20)

host_univ2_haplotype<-plot_grid(host_univ_haplotype, legend_haplotype, ncol=2, nrow=1, rel_widths = c(1, .5))

ggsave(filename="Figures/Univariate/Host_Univariate_Panel_HaplotypePOR.png", plot=host_univ2_haplotype, dpi=150, width=8, height=22, units="in")
```
...
ggsave(filename="Figures/Univariate/Symbiont_Univariate_Panel_HaplotypePOC.png", plot=symbiont_univ2_haplotype, dpi=150, width=13, height=15, units="in")
```
...
ggsave(filename="Figures/Univariate/Host_Univariate_Panel_HaplotypePOC.png", plot=host_univ2_haplotype, dpi=150, width=8, height=22, units="in")
```

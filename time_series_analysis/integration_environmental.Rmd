...
png(filename="Figures/Environmental_Radar_Temperature.png", width=3080, heigh=1880, units="px", res=300)
ggRadar(radar, aes(colour=site), scales="fixed")+ggplot2::theme_minimal()+ggplot2::theme(text=element_text(color="black", size=11))+ggplot2::theme(legend.position="top")
dev.off()

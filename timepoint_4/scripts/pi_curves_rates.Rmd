...
Example of colony that runs: 
```{r}
df %>%
  filter(colony_id == c("ACR-139")) %>%
  pull(thin_data_plot)
df %>%
  filter(colony_id == c("BK-10")) %>%
  pull(thin_data_plot)
df %>%
  filter(colony_id == c("POR-83")) %>%
  pull(thin_data_plot)
...
Example of colony that does not run: 
```{r}
df %>%
  filter(colony_id == c("ACR-220")) %>%
  pull(thin_data_plot)

df %>%
  filter(colony_id == c("BK-3")) %>%
  pull(thin_data_plot)

df %>%
  filter(colony_id == c("POC-359")) %>%
  pull(thin_data_plot)

df %>%
  filter(colony_id == c("POR-340")) %>%
  pull(thin_data_plot)

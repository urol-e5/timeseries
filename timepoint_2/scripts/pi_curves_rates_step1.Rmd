...
sample.info <- read_csv(file = "data/2_pi_curves/2_pi_curves_sample_metadata.csv")
...
Info needs to be same time format as the data0
...
sa <- read.csv("output/2_surface_area.csv") #used to be 2_surface_area_junk.csv
...
pr.out %>%
  ...
  write_csv(., path = "output/2_pi_curve_rates.csv")
```
...
#ggsave("output/2_pi_curve_vis.pdf", plot = last_plot(), width = 5, height = 10, units ="in")
```

...
# Define PI curve function as a nonlinear least-squares quadratic fit and test the nls model
Aquatic photosynthesis, Falkowski   
Pmax = max photosynthesis (AKA Am from Bayesian script)  
alpha = quantum yield (AKA AQY from Bayesian script)  
...
Equation for Ic derived from the quadratic equation by Ferdi P. Ic = PAR when Pc = 0 (x intercept). This matches expected values from each colony plot. Ic = light compensation point, the point at which photosynthesis is released from carbon limitation. 

Ik (saturating irradiance) is the point at which photosynthesis reaches the maximum of the initial slope: Am/AQY.
